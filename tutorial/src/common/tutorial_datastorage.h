...
namespace IsoAgLibTutorial {
  ...
  class tutorialDataStorage_c: public IsoAgLib::iIdentDataStorage_c,
    ...
    public:
      ...
      void storeSa(const uint8_t a_sa) override {
        _storeSa(a_sa);
      }

      void loadDtcs( IsoAgLib::iDtcContainer_c &arc_dtcContainer ) override
      {
        _loadDtcs(arc_dtcContainer);
      }
      void storeDtcs( const IsoAgLib::iDtcContainer_c &arc_dtcContainer ) override
      {
    ...
    private:
      ...
      void _loadDtcs( IsoAgLib::iDtcContainer_c &arc_dtcContainer );
      void _storeDtcs( const IsoAgLib::iDtcContainer_c &arc_dtcContainer );
